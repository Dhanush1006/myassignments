...
public class Delete {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@name ='Opportunity-search-input']")).sendKeys("Salesforce Automation by Dhanush");
		Thread.sleep(4000);
		...
		Thread.sleep(1000);
		WebElement OpportunityFound = driver.findElement(By.xpath("//a[text()='Salesforce Automation by Dhanush']"));
		String text = OpportunityFound.getText();
		if (text.equals("Salesforce Automation by Dhanush")) {
